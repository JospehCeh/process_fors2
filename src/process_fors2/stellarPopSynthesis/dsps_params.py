...
DEFAULT_DUST_PARAMS_MIN = DEFAULT_DUST_PARAMS + np.array([-1.0, -1.0, -0.3])  # former min -0.1 for PLAW_SLOPE
...
DEFAULT_AGEDEPLGMET_PARAMS_MAX = np.array([2.0, 0.0])
...
if FLAG_INCREASE_RANGE_MAH:
    # MAH_lgmO
    DEFAULT_MAH_PARAMS_MIN[0] = 8  # defaults min is 9
    DEFAULT_MAH_PARAMS_MAX[0] = 16  # defaults max is 14
    # MAH_logtc
    DEFAULT_MAH_PARAMS_MIN[1] = 0.01
    DEFAULT_MAH_PARAMS_MAX[1] = 0.3  # 0.15
    # MAH_early_index
    DEFAULT_MAH_PARAMS_MIN[2] = 0.05  # 0.1
    DEFAULT_MAH_PARAMS_MAX[2] = 10.0  # 0.10 -- erreur de frappe? ça bloquait cette valeur à 0.1
    # MAH_late_index
    DEFAULT_MAH_PARAMS_MIN[3] = 0.01  # 0.1
...
if FLAG_INCREASE_RANGE_MS:
    ...
    DEFAULT_MS_PARAMS_MAX[0] = 16.0  # 13.0
    # MS_lgy_at_mcrit : -1
    DEFAULT_MS_PARAMS_MIN[1] = -2.0
    DEFAULT_MS_PARAMS_MAX[1] = -0.3  # -0.7
    # MS_indx_lo : 1
    DEFAULT_MS_PARAMS_MIN[2] = 0.7
    DEFAULT_MS_PARAMS_MAX[2] = 3.0  # 2.0
    # MS_indx_hi : -1
    DEFAULT_MS_PARAMS_MIN[3] = -3.0  # -2.0
...
if FLAG_INCREASE_RANGE_Q:
    ...
    # ('Q_lg_drop', -1.01773),
    DEFAULT_Q_PARAMS_MIN[2] = -1.3  # -2.0
    DEFAULT_Q_PARAMS_MAX[2] = -0.8  # -0.5
    # ('Q_lg_rejuv', -0.212307),
